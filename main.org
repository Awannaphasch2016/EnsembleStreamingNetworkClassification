...
#+caption: The figure illustrate ensemble framework for sliding windows. Rectangle labeled $w_i$ is window index relative to the most recent window, called referenced window. Index of windows that come after the referenced window are increamentally increase by 1 and index of windows that come before are incrementally decrease by 1. At the top of the figure is input sequential data and at the bottom is ensemble data.
#+attr_html: :width 500px
[[file:./images/screenshot_20220502_124024.png]]
