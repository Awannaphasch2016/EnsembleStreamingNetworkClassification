...
\label{sec:org31c6caa}
\subsection{Static Graph Modeling}
\label{sec:org12e1b37}
...
\WHILE{$edge\_index < data.size$}
    ...
    \FOR{each $index$ in $ensembles$}
        ...
        \FOR{$(pn, kl, stride)$ in $temporal_\_parameters\_set$}
