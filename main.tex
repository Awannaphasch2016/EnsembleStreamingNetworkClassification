...
\label{sec:org088432d}
\subsection{Static Graph Modeling}
\label{sec:orgc16e89a}
...
\section{Approaches}
\label{sec:org2c824d8}
\subsection{Sliding Window Evaluation}
\label{sec:orgd69050d}
...
\subsubsection{create diagram to process tgn using dynamic graph diagram.}
\label{sec:org2940310}

\subsection{Temporal Graph Neural Network (TGN)}
\label{sec:org6df21d7}

\begin{figure}[htbp]
\centering
\includegraphics[width=.9\linewidth]{./images/screenshot_20220417_223019.png}
