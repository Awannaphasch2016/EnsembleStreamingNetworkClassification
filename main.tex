...
\label{sec:org287b4f1}
\subsection{Static Graph Modeling}
\label{sec:orge8b86e4}
...
\subsubsection{{\bfseries\sffamily TODO} add TGN image}
\label{sec:org3ee0c7f}
\subsection{Sliding Window Evaluation}
\label{sec:orga3ee33c}
